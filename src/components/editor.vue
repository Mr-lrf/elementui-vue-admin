<template>
    <div>
         <div ref="editor" style="text-align:left; z-index: 2;"></div>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            this.editor.customConfig.uploadImgServer = "https://img.cdkbit.com/api/1/upload/?key=02df0e4a26adde0fde71ef752ed900d1";
